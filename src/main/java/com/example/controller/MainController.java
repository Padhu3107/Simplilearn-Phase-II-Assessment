...
public class MainController {
	...
	public String validateAdminLogin(@RequestParam (value="username") String username, @RequestParam (value="password") String password) {
	...
	public String doMastStaffMaint(@RequestParam("staffId") String staffId, @RequestParam("staffName") String staffName) {
	...
	public String doMastClassMaint(@RequestParam("classId") String classId, @RequestParam("classDesc") String classDesc) {
	...
	public String doMastSubMaint(@RequestParam("subjectId") String subjectId, @RequestParam("subjectName") String subjectName) {
...
//	public String saveStudentMaint( @ModelAttribute("studentDetailsVO") StudentDetailsVO details, BindingResult result, Model model) {
//		model.addAttribute("studentDetailsVO", new StudentDetailsVO());
//		if(result.hasErrors()) {
//			return "StaffMaint";
//		} else {
//			//model.put("classId",details.getClassId());
//			//model.put("rollNo",details.getRollNo());
//			//model.put("subjectId",details.getSubjectId());
//			return "StaffMaint";
//		}
//	}
...
//		classVO.setClassId(classId);
//		SubjectVO subjectVO =  new SubjectVO();
//		subjectVO.setSubjectId(subject);
//		Map<ClassVO,SubjectVO> subjectsSet = new HashMap<ClassVO,SubjectVO>();
//		subjectsSet.put(classVO,subjectVO);
//		studentVO.setStudentId(student);
//		studentVO.setClassId(classVO);
//		studentVO.setSubjects(subjectsSet);
//		studentsRepo.save(studentVO);
